...
#define BOT_TOKEN "2083308237:AAHah19Z_pbLGS4zcmEdh3-JQ2IT_gm0xQE"

//Troque pelo ssid e senha da sua rede WiFi
#define SSID      "Consult e Auto"
#define PASSWORD  "automacaoeconsultoria"
...
String validSenderIds[SENDER_ID_COUNT] = {"878911979", ""};
...
void setup()
{
  ...
  bot.sendMessage(validSenderIds[0], "Bot started up", "");
